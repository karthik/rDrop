...
# Error 1
# Issues, the leading slash is very important. That's what led to
#   the error below.
# >dropbox_move(cred,'/test.csv','test_works/test.csv')
# Error in
#   fromJSON(cred$OAuthRequest('https://api.dropbox.com/1/fileops/move',
#   :
...
# from_path - Required. Specifies the file or folder to be moved
#   from relative to root.
...
# RETURNS
# Metadata for the moved file or folder. More information on the
#   returned metadata fields are available here.
...
# }
# ERRORS
# 403 An invalid move operation was attempted (e.g. there is already
#   a file at the given destination, or moving a shared folder into
#   a shared folder).
